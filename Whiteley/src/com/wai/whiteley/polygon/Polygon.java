...
public class Polygon {
	...
	public boolean inBoundingBox(RectF rect) {
		
		Point pointLeftTop = new Point(rect.left, rect.top);
		Point pointRightTop = new Point(rect.right, rect.top);
		Point pointLeftBottom = new Point(rect.left, rect.bottom);
		Point pointRightBottom = new Point(rect.right, rect.bottom);
		
		if(inBoundingBox(pointLeftTop) && inBoundingBox(pointRightTop) && inBoundingBox(pointLeftBottom) && inBoundingBox(pointRightBottom))
			return true;
